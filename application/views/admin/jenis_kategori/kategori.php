<div class="container-fluid">
    <div class="row">
        <div class="col-md-4 project-list">
            <div class="card">
                <?php echo form_open_multipart('admin/kategori/save'); ?>
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" placeholder="kategori Surat">
                        <?= form_error('nama_kategori', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($kategori as $key) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="javascript:void(0);" class="ubah_data" data-id="<?= $key['id']; ?>" data-name="<?= $key['nama_kategori']; ?>"><i class="icon-pencil-alt"></i></a></li>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-primary" href="<?= base_url('admin/kategori/delete/') . $key['id'] ?>">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
