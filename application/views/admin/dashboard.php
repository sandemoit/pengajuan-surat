    ...
    <div class="row widget-grid">
        <div class="col-xxl-4 col-sm-6 box-col-6">
            <div class="card profile-box">
                <div class="card-body">
                    ...
                    <div class="cartoon"><img class="img-fluid" src="<?php echo base_url('assets') ?>/images/dashboard/cartoon.svg" alt="vector women with leptop"></div>
                </div>
            </div>
        </div>
        ...
        <!-- <div class="col-xxl-8 col-lg-12 box-col-12">
                                        ...
                                        <div class="row g-sm-4 g-2">
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use href="<?php echo base_url('assets') ?>/svg/icon-sprite.svg#income"></use>
                                                        </svg>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use href="<?php echo base_url('assets') ?>/svg/icon-sprite.svg#expense"></use>
                                                        </svg>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use href="<?php echo base_url('assets') ?>/svg/icon-sprite.svg#doller-return"></use>
                                                        </svg>
                                                    </div>
                                ...
                                <div class="card-body pt-0">
                                    <div class="appointment-table table-responsive">
                                        <table class="table table-bordernone">
                                            <tbody>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/1.jpg" alt="user"></td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/2.jpg" alt="user"></td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/3.jpg" alt="user"></td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/4.jpg" alt="user"></td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/5.jpg" alt="user"></td>
                    ...
                    <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                        <div class="card purchase-card"><img class="img-fluid" src="<?php echo base_url('assets') ?>/images/dashboard/purchase.png" alt="vector mens with leptop">
                    ...
                    <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                        <div class="card papernote-wrap">
                            ...
                            <div class="card-body pt-0"> <img class="banner-img img-fluid" src="<?php echo base_url('assets') ?>/images/dashboard/papernote.jpg" alt="multicolor background">
                                <div class="note-content mt-sm-4 mt-2">
                                    ...
                                    <div class="mt-sm-4 mt-2 user-details">
                                        <div class="customers">
                                            <ul>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/1.jpg" alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/6.jpg" alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/7.jpg" alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/3.jpg" alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle" src="<?php echo base_url('assets') ?>/images/dashboard/user/8.jpg" alt="user"></li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright <?php echo date('Y') ?> © sandemo by Cuba theme </p>
            </div>
        </div>
    </div>
</footer>
