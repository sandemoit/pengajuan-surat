...
<head>
	...
	<title><?= $title ?></title>
	<link rel="icon" type="image/x-icon" href="<?= base_url() ?>assets/home/img/favicon.ico" />
	...
	<link href="<?= base_url() ?>assets/home/css/progress_bar.css" rel="stylesheet" />
	<link rel="stylesheet" href="<?= base_url() ?>assets/home/jquery-ui-1.12.1/jquery-ui.css">
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?= base_url() ?>assets/home/img/logo.svg" alt="Kelurahan" /></a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<li class="nav-item"><a class="nav-link" target="_blank" href="<?= base_url('admin/auth') ?>">Login</a></li>
				</ul>
			</div>
		</div>
	</nav>