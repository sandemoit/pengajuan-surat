...
<div class="portfolio-modal modal fade" id="skelurahan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal"><img src="<?= base_url('assets/') ?>home/img/close-icon.svg" alt="Close modal" /></div>
            <div class="container">
...
<!-- Contact form JS-->
<script src="<?= base_url('assets/') ?>home/mail/jqBootstrapValidation.js"></script>
<script src="<?= base_url('assets/') ?>home/mail/contact_me.js"></script>
<!-- Core theme JS-->
<script src="<?= base_url('assets/') ?>home/js/scripts.js"></script>
<script src="<?= base_url('assets/') ?>home/jquery-ui-1.12.1/jquery-ui.js"></script>
</body>
